...
LANGCHAIN_TRACING_V2 = _require("LANGCHAIN_TRACING_V2", "false")
LANGCHAIN_PROJECT = _require("LANGCHAIN_PROJECT", "ai-airport-companion")

ENVIRONMENT = _require("ENVIRONMENT", "development")